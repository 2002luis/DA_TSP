...
public:
    /**
     * @brief Default constructor for AdjacencyMatrix (unused)
     *
     */
    AdjacencyMatrix();
    ...
    /**
     * @brief Returns the optimal path for TSP using bruteforce
     * Complexity O(N!)
     * @return
     */
    std::vector<int> tspBruteforce();
    /**
     * @brief The recursive function call for the solution using dynamic programming
    ...
    /**
     * @brief The function that calculates TSP using dynamic programming
    ...
    /**
     * @brief Generates the memo matrix with everything set to 0. This should be done only when needed as to not use unnecessary space in the memory!
     */
    void generateMemo();
    /**
